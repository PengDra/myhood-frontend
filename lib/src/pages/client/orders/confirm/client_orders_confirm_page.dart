...
import 'package:myhood/src/pages/client/orders/confirm/client_orders_confirm_controller.dart';
...
class ClientOrdersConfirmPage extends StatefulWidget {
  const ClientOrdersConfirmPage({Key key}) : super(key: key);

  @override
  State<ClientOrdersConfirmPage> createState() =>
      _ClientOrdersConfirmPageState();
}

class _ClientOrdersConfirmPageState extends State<ClientOrdersConfirmPage> {
  ClientOrdersConfirmController _con = ClientOrdersConfirmController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Mi Orden'+_con.selectedProducts.length.toString()),
  ...
  Widget _cardProduct(Product product) {
    return Container(
        ...
        child: Row(children: [
          ...
          Spacer(),
          Column(children: [_textPrice(product)])
        ]));
  }
        ...
        child: Column(
          children: [
            ...
            Row( children: [
              ...
              Spacer(),
              Text('${_con.deliveryPrice}',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
          ]),
            Row(children: [
              //agrega una fila con el valor del deliveryPrice
